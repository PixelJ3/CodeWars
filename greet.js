...
P: 
create a object and store 'welcome' in all sort of languages
create a function that takes in a parameter of a language
return the requested language 'welcome' using langs[lang]
*/
...
greet("english"); // expected output: 'Welcome', "Your function should have returned 'Welcome'. Try again.")
greet("dutch"); // expected output: 'Welkom', "Your function should have returned 'Welkom'. Try again.")
greet("IP_ADDRESS_INVALID"); // expected output: 'Welcome', "Your function should have returned 'Welcome'. Try again.")
