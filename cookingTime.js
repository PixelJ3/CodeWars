...
Your Task
Implement a function, which takes a non-negative integer, representing the number of eggs to boil. It must 
...
P: you will be given a non-negative int
R: return the time in minutes(integer), which it takes to have all the eggs boiled.
E: (Input --> Output)
0 --> 0
5 --> 5
10 --> 10
P: 
create a function that takes in a num(eggs)
using math.ceil() divide eggs / 8
mult dividend by 5
return output
*/
